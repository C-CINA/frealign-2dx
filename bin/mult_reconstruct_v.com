...
${fm},0,F,F,F,F,0,${FBEAUT},${FFILT},F,F,3,F,0,1		!CFORM,IFLAG,FMAG,FDEF,FASTIG,FPART,IEWALD,FBEAUT,FFILT,FBFACT,FMATCH,IFSC,FDUMP,IMEM,INTERP
...
${data_input}_${start}_r${4}.${extension}
...
\rm ${data_input}_${start}_r${4}.par
\rm ${data_input}_${start}_r${4}_n${1}.res
