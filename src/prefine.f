...
C**************************************************************************
     ...
     +                   PSIM,SPSI,STIF,PWEIGHTS,FFTW_PLANS,SM,SIGRAD,
     +                   SIGPHA,IRAN,FRAC,KK)
C**************************************************************************
...
C
      ...
      DATA ESCALE/100.0/
C**************************************************************************
C       PRINT *,'PREFINE SIGANG: ',SIGANG
C       PRINT *,'PREFINE SIGSHF: ',SIGSHF
C       PRINT *,'IRAN: ',IRAN
...
C ###############################################
C RANDOM SUBSET REFINEMENT CURRENTLY ACTIVATED:
C ###############################################
      IF (RANDOM(IRAN).GT.FRAC) THEN
        WRITE(*,502) KK
502     FORMAT(' Particle ',I6,' not refined in this cycle.')
        PRESA=-PRESA
        RETURN
      ENDIF
...
501   FORMAT(' on entry to  PREFINE PHI,THETA,PSI,DSHX,DSHY,PRESA=',
     .       5F9.3,F7.2,/,2I8,7F9.3)
      ...
      IF (AMAG.LT.0.0) THEN
      	...
      	XPARMAP(NPAR)=XPAR(6)
      	EPARMAP(NPAR)=EPAR(6)
      CALL VA04A(XPARMAP,EPARMAP,NPAR,PRESA,ESCALE,0,1,
     .     NCYCLS,XPAR,NPAR,NSAM,MAXR1,MAXR2,MASK,
