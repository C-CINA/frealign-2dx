...
c ---------------------------------------------------------------------
	...
	REAL FSC(*),QC(*),AVFSPR,AVFSC,AVQ,AVQRAN,BFACT,RMASK(3)
...
c ---------------------------------------------------------------------
        ...
        ISUMV=0
        ISUMP=0
        WRITE(NDOC1+1,9996)(RMASK(1)+NSAM/2)*PSIZE,
     +  (RMASK(2)+NSAM/2)*PSIZE,(RMASK(3)+NSAM/2)*PSIZE
9996    FORMAT('C'/
     +         'C  Center of reconstruction mask = ',3F8.2/
     +         'C')
