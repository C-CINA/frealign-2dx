...
C*
C**************************************************************************
      SUBROUTINE MAGREFINE(AMAGP,DFMID1,DFMID2,ANGAST,
     +		IFIRSTF,LASTF,NP,NSAM,MAXR1,MAXR2,MASK,
     +		C3DF,IRAD,PBUF,
     ...
     +          PSSNR,FFTW_PLANS,SM,SIGRAD,SIGPHA)
C**************************************************************************
...
C       IRAN=123456
      ...
      CALL VA04A(XPAR,EPAR,1,PRESA,ESCALE,0,1,NCYCLS,XP,
     .   NP,NSAM,MAXR1,MAXR2,MASK,C3DF,
